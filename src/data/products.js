export const products = [
  ...
  {
    id: 'fromages-chevre',
    title: 'Fromages de chèvre',
    description:
      'Fraîcheur, nuances lactiques et herbacées. En saison : frais, cendrés, affinés.. Exemples : Crottin de Chavignol, Sainte-Maure, Valençay.',
    accent: '❤️ Notre Coup de cœur : chèvre à l’ail des ours',
    images: [
      { src: '/images/1.png', alt: 'Fromage de chèvre 1' },
      { src: '/images/2.png', alt: 'Fromage de chèvre 2' },
      { src: '/images/3.png', alt: 'Fromage de chèvre 3' },
    ],
  }
