    ...
    <main className='home'>
      ...
      <section id="fromages">
        <div className="container">
          ...
          <p>
            Fermes et savoureux, affinés avec soin. Exemples : Comté, Beaufort,
            Abondance, Reblochon, Morbier, Gruyère, Emmental, Tomme de Savoie.
            <span>
      ...
      <section id="charcuterie">
        <div className="container">
          ...
          <p>
            ...
            saucissons… Saucissons : nature, noix, Beaufort, poivre, herbes.
          </p>
        </div>
      </section>
      ...
      <section id="epicerie">
        <div className="container">
          ...
          <p>
            ...
            confits, miels, confitures, vins de Savoie, bières locales, génépi…
          </p>
        </div>
      </section>
      <p>
